<template>
    <div class="login-container">
        <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
            <h3 class="title">测试SCRM</h3>
            <el-form-item prop="username">
                <span class="svg-container">
                    <svg-icon icon-class="user" />
                </span>
                <el-input v-model="loginForm.username" name="username" type="text" auto-complete="on" placeholder="用户名称" />
            </el-form-item>
            <el-form-item prop="password">
             ...
             <!-- <el-form-item>
                <span style="color:#FFF;">username:vencenty  password:123456</span>
             </el-form-item> -->
             <el-form-item>
    ...
    methods: {
        ...
        handleLogin() {
            this.$refs.loginForm.validate(valid => {
                if (valid) {
                    this.loading = true;
                    let loginForm = extend(true, this.loginForm);
                    adminLogin(this.loginForm)
                        .then(res => {
                            // 存储Token
                            localStorage.setItem('UserToken', res.d.access_token);
